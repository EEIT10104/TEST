                ...
                <div class="entry-content">
                    <div class="content-wrap relative">
                        ...
                        <div class="one_half last ">
                            <h1>Start Add Season</h1>
                            
                            <form:form method='POST' modelAttribute="seasonBean">
			<fieldset>
				<div class="form-group">
					<label> 賽季名稱 </label>
					<div>
						<form:input path="seasonName" />
					</div>
				</div>
				...
				<div>
					...
					<div class="form-group">
						<label> 賽制 </label>
						<div>
							<form:input path="competitionSystem" />
						</div>
					</div>
					<div class="form-group">
						<label> 組別 </label>
						<div>
							<form:input path="seasonGroup" />
						</div>
					</div>
					<div class="form-group">
						<label> 隊伍上限 </label>
						<div>
							<form:input path="teamMax" />
						</div>
					</div>
					<div class="form-group">
						<label> 隊伍下限</label>
						<div>
							<form:input path="teamMin" />
						</div>
					</div>
					<div class="form-group">
						<label> 球員上限</label>
						<div>
							<form:input path="playerMax" />
						</div>
					</div>
					<div class="form-group">
						<label> 球員下限</label>
						<div>
							<form:input path="playerMin" />
						</div>
					</div>
					<div class="form-group">
						<label> 報名金額</label>
					...
					<div >
						<input type='submit' value="ADD SEASON" class="addseason"/>
					</div>
				</div>
			</fieldset>
		</form:form>
